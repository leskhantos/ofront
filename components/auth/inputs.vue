<template>
  <div class="input-container" :style="{ marginBottom: marginBottom }">
    <div class="caption">
    ...
    <div class="field-wrapper">
      ...
      <transition name="input-error">
        <div class="error" v-if="error">{{ error[0] }}</div>
      </transition>
    </div>
  </div>
</template>
...
<style lang="scss" scoped>
  .input-container {
    ...
    .caption {
      ...
      //   width: 5px;
      //   height: 42px;
      //   background-image: url("/auth-input-left.png");
      //   margin-left: -5px;
      // }
      ...
      //   width: 8px;
      //   height: 42px;
      //   background-image: url("/auth-input-center.png");
      //   z-index: 20;
      // }
    }
    ...
    .field-wrapper {
      ...
      .field {
        ...
        //   height: 42px;
        //   margin-right: -4px;
        //   background-image: url("/auth-input-right.png");
        //   z-index: 20;
        // }
      }
    }
